...
public class Enemy : MonoBehaviour
{
    ...
    private void CreateInitialPoints()
    {
        ...
        moveSpot1.position = new Vector3(gameObject.transform.position.x + Random.Range(1,-1), gameObject.transform.position.y - Random.Range(2, -2));
        moveSpot2.position = new Vector3(gameObject.transform.position.x - Random.Range(2, -2), gameObject.transform.position.y + Random.Range(2, -2));
